...
public class ChatServer {
	...
	private static HashSet<String> selectedClientNames = new HashSet<String>();	

	/* Fore store client names and PrintWriter */
	private static HashMap<String, PrintWriter> clientNameWithPrintWriter = new HashMap<String, PrintWriter>();
			...
			try {
				...
				while (true) {
					...
					if (input.startsWith("SELECTEDMESSAGE")) {
						...
						/* clear selectedClientNames for accept new. */
				...
				if (name != null) {
					...
					clientNameWithPrintWriter.remove(name);
